...
public class NLPTreeEditPanel extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        btnAddParent.addActionListener(this::btnAddParentActionPerformed);
        btnDeleteNode = new JButton("-");
        btnDeleteNode.addActionListener(this::btnDeleteNodeActionPerformed);
        btnDiscardChanges = new JButton("Discard");
        btnDiscardChanges.addActionListener(this::btnDiscardChangesActionPerformed);
